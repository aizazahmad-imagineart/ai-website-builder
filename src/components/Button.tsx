...
const variants: Record<Variant, string> = {
  // This page's signature violet accent — only used for in-content CTAs
  // (Hero, FinalCta). SiteNav's CTA is styled separately and stays
  // near-black, so shared chrome remains consistent with every sub-feature page.
  brand:
    "bg-accent text-white transition-[filter] hover:brightness-110",
  ghost:
